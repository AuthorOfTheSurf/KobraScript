...
describe('The scanner', function () {
    ...
    it('properly processes a Blueprint file', function (done) {
        scan('test/kobra-code/good-programs/Person.ksb', function (tokens) {
            ...
            i(tokens[49]).should.equal(i({kind:'ID',lexeme:'say',line:12,col:9}))
            i(tokens[50]).should.equal(i({kind:'(',lexeme:'(',line:12,col:12}))
            i(tokens[51]).should.equal(i({kind:'STRLIT',lexeme:'I will weigh less',line:12,col:13}))
            i(tokens[52]).should.equal(i({kind:')',lexeme:')',line:12,col:32}))
            i(tokens[53]).should.equal(i({kind:'..',lexeme:'..',line:13,col:5}))
            i(tokens[54]).should.equal(i({kind:',',lexeme:',',line:13,col:7}))
            i(tokens[55]).should.equal(i({kind:'ID',lexeme:'kilos',line:14,col:5}))
            i(tokens[56]).should.equal(i({kind:':',lexeme:':',line:14,col:10}))
            i(tokens[57]).should.equal(i({kind:'fn',lexeme:'fn',line:14,col:12}))
            i(tokens[58]).should.equal(i({kind:'(',lexeme:'(',line:14,col:14}))
            i(tokens[59]).should.equal(i({kind:'ID',lexeme:'x',line:14,col:15}))
            i(tokens[60]).should.equal(i({kind:')',lexeme:')',line:14,col:16}))
            i(tokens[61]).should.equal(i({kind:':',lexeme:':',line:14,col:17}))
            i(tokens[62]).should.equal(i({kind:'return',lexeme:'return',line:15,col:9}))
            i(tokens[63]).should.equal(i({kind:'ID',lexeme:'x',line:15,col:16}))
            i(tokens[64]).should.equal(i({kind:'/',lexeme:'/',line:15,col:18}))
            ...
            i(tokens[71]).should.equal(i({kind:'ID',lexeme:'name',line:20,col:5}))
            i(tokens[72]).should.equal(i({kind:':',lexeme:':',line:20,col:9}))
            i(tokens[73]).should.equal(i({kind:'fn',lexeme:'fn',line:20,col:11}))
            i(tokens[74]).should.equal(i({kind:'(',lexeme:'(',line:20,col:14}))
            i(tokens[75]).should.equal(i({kind:')',lexeme:')',line:20,col:15}))
            i(tokens[76]).should.equal(i({kind:':',lexeme:':',line:20,col:16}))
            i(tokens[77]).should.equal(i({kind:'return',lexeme:'return',line:20,col:18}))
            i(tokens[78]).should.equal(i({kind:'ID',lexeme:'name',line:20,col:25}))
            i(tokens[79]).should.equal(i({kind:'..',lexeme:'..',line:20,col:30}))
            i(tokens[80]).should.equal(i({kind:',',lexeme:',',line:20,col:32}))
            i(tokens[81]).should.equal(i({kind:'ID',lexeme:'age',line:21,col:5}))
            i(tokens[82]).should.equal(i({kind:':',lexeme:':',line:21,col:8}))
            i(tokens[83]).should.equal(i({kind:'fn',lexeme:'fn',line:21,col:10}))
            i(tokens[84]).should.equal(i({kind:'(',lexeme:'(',line:21,col:13}))
            i(tokens[85]).should.equal(i({kind:')',lexeme:')',line:21,col:14}))
            i(tokens[86]).should.equal(i({kind:':',lexeme:':',line:21,col:15}))
            i(tokens[87]).should.equal(i({kind:'return',lexeme:'return',line:21,col:17}))
            i(tokens[88]).should.equal(i({kind:'ID',lexeme:'age',line:21,col:24}))
            i(tokens[89]).should.equal(i({kind:'..',lexeme:'..',line:21,col:28}))
            i(tokens[90]).should.equal(i({kind:',',lexeme:',',line:21,col:30}))
            i(tokens[91]).should.equal(i({kind:'ID',lexeme:'hairColor',line:22,col:5}))
            i(tokens[92]).should.equal(i({kind:':',lexeme:':',line:22,col:14}))
            i(tokens[93]).should.equal(i({kind:'fn',lexeme:'fn',line:22,col:16}))
            i(tokens[94]).should.equal(i({kind:'(',lexeme:'(',line:22,col:19}))
            i(tokens[95]).should.equal(i({kind:')',lexeme:')',line:22,col:20}))
            i(tokens[96]).should.equal(i({kind:':',lexeme:':',line:22,col:21}))
            i(tokens[97]).should.equal(i({kind:'return',lexeme:'return',line:22,col:23}))
            i(tokens[98]).should.equal(i({kind:'ID',lexeme:'hairColor',line:22,col:30}))
            i(tokens[99]).should.equal(i({kind:'..',lexeme:'..',line:22,col:40}))
            //    Begin synset.
            i(tokens[100]).should.equal(i({kind:'@',lexeme:'@',line:24,col:1}))
            i(tokens[101]).should.equal(i({kind:'syn',lexeme:'syn',line:24,col:2}))
            i(tokens[102]).should.equal(i({kind:':',lexeme:':',line:24,col:5}))
            i(tokens[103]).should.equal(i({kind:'ID',lexeme:'set',line:24,col:6}))
            i(tokens[104]).should.equal(i({kind:'ID',lexeme:'hairColor',line:25,col:5}))
            i(tokens[105]).should.equal(i({kind:':',lexeme:':',line:25,col:14}))
            i(tokens[106]).should.equal(i({kind:'fn',lexeme:'fn',line:25,col:16}))
            i(tokens[107]).should.equal(i({kind:'(',lexeme:'(',line:25,col:18}))
            i(tokens[108]).should.equal(i({kind:'ID',lexeme:'newColor',line:25,col:19}))
            i(tokens[109]).should.equal(i({kind:')',lexeme:')',line:25,col:27}))
            i(tokens[110]).should.equal(i({kind:':',lexeme:':',line:25,col:28}))
            i(tokens[111]).should.equal(i({kind:'ID',lexeme:'color',line:26,col:9}))
            i(tokens[112]).should.equal(i({kind:'=',lexeme:'=',line:26,col:15}))
            i(tokens[113]).should.equal(i({kind:'ID',lexeme:'newColor',line:26,col:17}))
            i(tokens[114]).should.equal(i({kind:'end',lexeme:'end',line:27,col:5}))
            //    GG.
            i(tokens[115]).should.equal(i({kind:'defcc',lexeme:'defcc',line:29,col:1}))
            i(tokens[116]).should.equal(i({kind:'EOF',lexeme:'EOF'}))
            done()
        })
    })
