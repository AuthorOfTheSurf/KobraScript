...
function scan(line, linenumber, tokens) {
    ...
    var start, 
        ...
        twoCharTokens = /<=|==|>=|\!=|\*\*|~=|is|&&|\|\||~\?|~\!|\.\.|\+\+|\-\-|\*=|\/=|-=|\+=|\->/,
        oneCharTokens = /[\!\+\-\%\?\*\/\(\),:;=<>\|\$\{\}\#\.\[\]@]/,
        definedTokens = /^(?:bit|int|float|bool|str|undefined|null|fn|return|construct|blueprint|has|does|syn|defcc|if|else|do|while|for|switch|break|continue|case|try|catch|finally|throw|function|instanceof|var|void|with|end|proc|say|loge|_hidden)$/,
